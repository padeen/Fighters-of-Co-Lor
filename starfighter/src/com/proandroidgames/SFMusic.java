...
public class SFMusic extends Service{
	   ...
	   public void onCreate() {         
		   super.onCreate();
		   context = this;
		   setMusicOptions(SFEngine.LOOP_BACKGROUND_MUSIC,SFEngine.R_VOLUME,SFEngine.L_VOLUME,
				   SFEngine.SPLASH_SCREEN_MUSIC);
		   }
	   public static void setMusicOptions(boolean isLooped, int rVolume, int lVolume, 
			   int soundFile){
